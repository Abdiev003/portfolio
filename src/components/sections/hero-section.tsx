...
const Avatar3D = dynamic(
  () => import("@/components/3d-avatar").then((mod) => mod.Avatar3D),
  { ssr: false }
);
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center lg:text-left space-y-8 order-2 lg:order-1">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-center lg:items-start lg:justify-start gap-4 animate-fade-in delay-300 z-10">
              <Button
                size="lg"
            ...
            {/* Social Links */}
            <div className="flex items-center justify-center lg:justify-start gap-4 pt-8 animate-fade-in delay-500">
              <HoverBorderGradient
                as="a"
